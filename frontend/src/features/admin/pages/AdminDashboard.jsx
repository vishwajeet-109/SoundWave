...
const AdminDashboard = () => {
  ...
  // 🚨 AdminLayout wrapper yahan se HATA diya hai!
  if (statsError) return <ErrorState message="Failed to load platform statistics." />;

  return (
    // 🚨 AdminLayout wrapper yahan se bhi HATA diya hai!
